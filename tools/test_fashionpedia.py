"""Evaluate zero-shot OWLv2 on the Fashionpedia validation split."""
...
def main() -> None:
    ...
    parser.add_argument(
        "--query-template",
        default=PHOTO_QUERY_TEMPLATE,
        help="Text prompt template containing {name}.",
    )
    ...
    print(f"Loading detection-datasets/fashionpedia split={args.split}...")
    ...
    coco_eval_with_custom_sizes(
        ...
        detections,
        dataset.class_names,
        title=f"Fashionpedia {args.split} set",
    )
